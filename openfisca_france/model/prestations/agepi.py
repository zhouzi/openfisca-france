...
class agepi(Variable):
    ...
    def formula(individu, period, parameters):
        ...
        montants_min = parameters(period).prestations.agepi.montants.minimum.calc(nb_enfants_eligibles)
        montants_max = parameters(period).prestations.agepi.montants.maximum.calc(nb_enfants_eligibles)
