...
class agepi_hors_mayotte(Variable):
    ...
    def formula(individu, period, parameters):
        ...
        montants_min_hors_mayotte = parameters(period).prestations.agepi.montants.hors_mayotte.minimum.calc(nb_enfants_eligibles)
        montants_max_hors_mayotte = parameters(period).prestations.agepi.montants.hors_mayotte.maximum.calc(nb_enfants_eligibles)
